...
class Personal_Enqueue_Scripts {
	...
	public function personal_scripts() {
		...
		wp_enqueue_style( 'boxicons', get_template_directory_uri() . '/assets/vendor/bootstrap-icons/boxicons.min.css', [], null );
		wp_enqueue_style( 'glightbox', get_template_directory_uri() . '/assets/vendor/bootstrap-icons/glightbox.min.css', [], null );
		wp_enqueue_style( 'remixicon', get_template_directory_uri() . '/assets/vendor/bootstrap-icons/remixicon.css', [], null );
		wp_enqueue_style( 'swiper-bundle', get_template_directory_uri() . '/assets/vendor/bootstrap-icons/swiper-bundle.min.css', [], null );
		...
		wp_enqueue_script( 'bootstrap-bundle', get_template_directory_uri() . 'assets/vendor/purecounter/bootstrap.bundle.min.js.js', [], _S_VERSION, true );
		wp_enqueue_script( 'glightbox', get_template_directory_uri() . 'assets/vendor/purecounter/glightbox.min.js', [], _S_VERSION, true );
		wp_enqueue_script( 'isotope', get_template_directory_uri() . 'assets/vendor/purecounter/isotope.pkgd.min.js', [], _S_VERSION, true );
		wp_enqueue_script( 'swiper-bundle', get_template_directory_uri() . 'assets/vendor/purecounter/swiper-bundle.min.js', [], _S_VERSION, true );
		wp_enqueue_script( 'noframework.waypoints', get_template_directory_uri() . 'assets/vendor/purecounter/noframework.waypoints.js', [], _S_VERSION, true );
		...
		wp_enqueue_script( 'personal-navigation', get_template_directory_uri() . '/assets/js/navigation.js', [], _S_VERSION, true );
